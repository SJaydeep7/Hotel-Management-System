...
$(document).ready(function () {
    ...
    // Line Chart Custom 1
    // ------------------------------------------------------ //
    var LINECHARTEXMPLE   = $('#lineChartCustom59');
 ...
 // Sample data for 12 months with a gap of 10,000
 const monthlyRevenueData = Array.from({ length: 12 }, (_, index) => (index + 1) * 10000);
 ...
 const ctx = document.getElementById('#lineChartCustom1').getContext('2d');
